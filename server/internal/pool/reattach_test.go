...
// Re-admission waits out the dwell interval. A node that reconnects, catches a
// few segments and drops again is worse than one that stays out: each brief
// reappearance pulls traffic onto data that is about to go stale again.
